    ...
    <div class="col-md-6 mx-auto">
        <form method="post" enctype="multipart/form-data">
            ...
            <div class="form-floating my-3">
                <select name="disables" class="form-select">
    ...
    <div class="col-md-6 mx-auto">
        <form method="post" enctype="multipart/form-data">
            ...
            <?php if (!empty($row)) : ?>
                ...
                <div class="form-floating my-3">
                    <select name="disables" class="form-select">
                        <option <?= old_select('disabled', '0', $row['disables']) ?> value="0">Yes</option>
                        <option <?= old_select('disabled', '1', $row['disables']) ?> value="1">No</option>
                    </select>
                    <label for="floatingInput">Active</label>
                </div>
...
<?php else : ?>
    ...
    <h4 class="mb-4">
        ...
        <a href="<?= ROOT ?>/admin/categories/add">
            <button class="btn btn-primary" style="margin-left: 1063px; position:relative; bottom:30px">Add
                Category</button>
        </a>
