...
<?php else : ?>
    ...
    <h4 class="mb-4">
        ...
        <a href="<?= ROOT ?>/admin/users/add">
            <button class="btn btn-primary" style="margin-left: 1000px;">Add User</button>
        </a>
            ...
            <?php if (!empty($rows)) : ?>
                <?php foreach ($rows as $row) : ?>
                    <tr>
                        ...
                        <td><?= date("j", strtotime($row['date'])) . ' tháng ' . date("n", strtotime($row['date'])) . ', ' . date("Y", strtotime($row['date'])) ?>
                        </td>
