...
<body>
    ...
    <div class="ism-slider" data-transition_type="fade" data-play_type="loop" id="my-slider">
        <ol>
            ...
            <!-- <li>
        <img src="assets/slider/ism/image/slides/summer-690332_1280.jpg">
        <div class="ism-caption ism-caption-0">My slide caption text</div>
      </li> -->
        </ol>
    </div>
    ...
    <main class="p-2">
        <h3 class="mx-4"> Introduce MyBlog </h3>
            ...
            <div class="col-md-6">
                <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                    <div class="col p-4 d-flex flex-column position-static">
                        <strong class="d-inline-block mb-2 text-primary"> The Members</strong>
                        <h3 class="mb-0">Chefs</h3>
                        <!-- <div class="mb-1 text-muted">Nov 12</div> -->
                        <p class="card-text mb-auto">General Introduction about my members who contribute this article
                            for MyBlog.</p>
                        <a href="#" class="stretched-link">Continue reading</a>
                    </div>
                    <div class="col-lg-5 col-12 d-lg-block">
                        <img class="bd-placeholder-img w-100" width="200" height="250" style=" object-fit:cover;" src="<?= ROOT ?>/assets/images/nghe-dau-bep-cet.jpg">
                        <!-- dua anh vao day nay: phut thu 20 -->
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="<?= ROOT ?>/login" class="nav-link p-0 text-muted">Login</a>
                        </li>
